...
and the Month it describes stop competing for the same pixels, which is the whole of the mode. Distinct from a Line Readout, which is figures for one Line
