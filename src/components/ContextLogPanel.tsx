 ...
 * tooltip to be pinned, and pinning a dot on the chart highlights and scrolls to
 * the row here. Without that pairing the panel is a second, unrelated list that
 * happens to share data.
 */
